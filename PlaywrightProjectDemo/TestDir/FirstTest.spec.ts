 ...
 */
/**
 * F10 - execute the present step and move to the next
 * F11 - step inside the method.
 * 
 */
...
test.describe('All test belongs to HeroKuapp',async()=>{
  ...
  test("Fill and Press-Sequentially test", async ({ page }) => {
    ...
    await test.step('Enter UserName',async()=>{
      ...
      await page
        .locator("#username")
        .pressSequentially(userName, { delay: 300 });
    })
